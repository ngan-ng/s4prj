...
import static com.aptech.apiv1.utils.strings.PnrGenerator.generatePnr;
...
public class BookingController {
    ...
    public ResponseEntity<?> createBookings(@RequestBody @Valid GroupBooking groupBooking, BindingResult bindingResult){
        try{
            ...
            return ResponseEntity.status(HttpStatus.CREATED).body(bookingService.createBookings(groupBooking));
        }catch (Exception ex){
